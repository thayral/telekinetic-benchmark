...
This complements the vision of my [PhD work](https://thayral.github.io/reactive-slip-control/) on low-level reflex control for manipulation https://thayral.github.io/reactive-slip-control/ . The fast-feedback stabilization layers can handle the physical contacts, and provide abstraction over interaction. But higher-level planning and reasoning still have to be grounded in objects and causal interaction for the 3D physical world. 
